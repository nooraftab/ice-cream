...
public class IceCreamConeView extends JComponent {
	...
	public static final int CONE_WIDTH = 30;  //40
	public static final int CONE_HEIGHT = 60;   //80

	//constants for the overlap and dimensions of our scoop
	public static final int SCOOP_OVERLAP = 15;   //15
	public static final int SCOOP_DIAMETER = 40;   //60
	 ...
	 *
	 * @param g allows pictures to be drawn
	 */
	public void paintFlavorScoops (Graphics g) {
